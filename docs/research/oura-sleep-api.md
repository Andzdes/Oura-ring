...
## Фоновая синхронизация: уточнение и начатый тест
...
в этом коротком окне не зафиксирована. Тест ещё не завершён:
нужно более длинное окно наблюдения либо контроль с открытием приложения.
Положительный результат подтвердит фоновую доставку активности; отсутствие
изменений за короткое окно не докажет невозможность фоновой синхронизации.
